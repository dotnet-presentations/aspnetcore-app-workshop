...
1. Open the `IdentityDbContext.cs` file and remove the unused `using` statement
1. Open the `IdentityHostingStartup.cs` file and remove the unused `using` statement
