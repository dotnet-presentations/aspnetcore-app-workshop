...
Previous:  [Session #1 - Get bits installed, build the back-end application with basic EF model](/docs/1.%20Create%20BackEnd%20API%20project.md) | Next: [Session #3 - Add front-end, render agenda, set up front-end models](3.%20Add%20front-end%2C%20render%20agenda%2C%20set%20up%20front-end%20models.md)