Previous:  [Session #1 - Setup, basic EF model](/docs/1.%20Create%20BackEnd%20API%20project.md)
...
Next: [Session #3 - Add front-end](3.%20Add%20front-end%2C%20render%20agenda%2C%20set%20up%20front-end%20models.md)