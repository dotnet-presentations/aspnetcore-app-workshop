...
## Adding Seed data
1. Copy in the base loader to the root of the BackEnd folder from [the GitHub completed application] (https://github.com/dotnet-presentations/aspnetcore-app-workshop/blob/master/src/BackEnd/BaseDataLoader.cs)
1. Copy in the implementation of the [DevIntersection JSON loader](https://github.com/dotnet-presentations/aspnetcore-app-workshop/blob/master/src/BackEnd/Data/DevIntersectionLoader.cs)
1. Copy in the JSON file of the [conference sessions](https://github.com/dotnet-presentations/aspnetcore-app-workshop/blob/master/src/BackEnd/DevIntersection_Vegas_2017.json)
