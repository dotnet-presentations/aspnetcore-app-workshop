...
Previous: [Session #4 - Add authentication, add admin policy, allow editing sessions, users can sign-in with Twitter and Google, custom auth tag helper](4.%20Add%20auth%20features.md) |
Next: [Session #6 - Deployment, Azure and other production environments, configuring environments, diagnostics](6.%20Deployment.md) 