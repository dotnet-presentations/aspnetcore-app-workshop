...
1. Now that the components and data service is created, open app.module.shared.ts to import the DataService component. Add the following to the top to import the module.
...
1. Update the template **sessiondetail.component.html**
...
1. Update the template **speakerdetail.component.html** to the following
