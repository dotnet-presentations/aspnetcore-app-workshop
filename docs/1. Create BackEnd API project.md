...
1. Create sub-folder BackEnd and create a project using `dotnet new webapi` at the cmd line inside the folder BackEnd
1. Add the project to the solution using `dotnet sln add BackEnd\BackEnd.csproj`
